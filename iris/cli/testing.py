...
class CliWrapper(object):
    def __init__(self, config):
        ...
        self.entry_point = load_entry_point('iris', 'console_scripts', 'iris')
...
class CliIntegrationTestCase(CliTestMixin, IrisIntegrationTestCase):
    use_zookeeper = True
    ...
    def setUp(self):
        ...
        self.cli_config = {
            ...
            "event_system": {
                "class": "iris.events.null:NullEventSystem",
            },
        }
