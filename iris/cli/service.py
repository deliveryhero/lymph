...
from iris.autoreload import set_source_change_callback
from iris.cli.base import Command
from iris.core.container import create_container
...
class InstanceCommand(Command):
    """
    Usage: iris instance [--ip=<address> | --guess-external-ip | -g]
