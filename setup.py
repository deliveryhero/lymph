...
setup(
    ...
    entry_points={
        ...
        'lymph.cli': [
            'discover = lymph.cli:DiscoverCommand',
            'emit = lymph.cli:EmitCommand',
            'help = lymph.cli:HelpCommand',
            'inspect = lymph.cli:InspectCommand',
            'instance = lymph.cli:InstanceCommand',
            'list = lymph.cli:ListCommand',
            'node = lymph.cli:NodeCommand',
            'request = lymph.cli:RequestCommand',
            'shell = lymph.cli:ShellCommand',
            'subscribe = lymph.cli:SubscribeCommand',
            'tail = lymph.cli:TailCommand',
        ],
